...
if pszonechangedalldel and CurrentTimepull>pszonechangedalldel+3 then
...
psnastdelay=nil
if (GetRealmName()=="Азурегос" and (UnitName("player")=="Дэи1" or UnitName("player")=="Дэина1")) or (GetRealmName()=="Гордунни" and UnitName("player")=="Шурш1") then
