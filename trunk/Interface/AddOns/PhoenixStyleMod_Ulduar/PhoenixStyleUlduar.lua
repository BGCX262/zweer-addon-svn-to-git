...
psfvezaxheal(arg2,arg7,arg12,arg1)
end
...
psfsovetdis(arg2,arg1,arg4,arg7)
end
...
psfmimidetectnoob(arg1,arg2,arg6,arg7)
end
...
if kolyoggaddov==7 or kolyoggaddov==8 then
if(whererepbossulda[6]=="sebe")then
DEFAULT_CHAT_FRAME:AddMessage("- "..psulyoggguard1.." "..(10-kolyoggaddov))
else
	if kolyoggaddov==7 then
pszapuskanonsa(whererepbossulda[6], psulyoggguard1.." "..(10-kolyoggaddov), nil, 1)
	elseif kolyoggaddov==8 then

if psanonceinst then
psyogginstango(psulyoggguard1.." "..(10-kolyoggaddov))
end
...
if psanonceinst then
SendChatMessage(psulyoggguard1.." "..(10-kolyoggaddov), "raid_warning")
end
	else
if psanonceinst then
psyogginstango(psulyoggguard1.." "..(10-kolyoggaddov))
...
if arg2=="UNIT_DIED" and arg7==psyoggfail4 and kolyoggaddov<10 then
