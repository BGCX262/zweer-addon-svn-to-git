...
if FW.CLASS == "WARLOCK" then
	...
	if ST then
		...
		-- id/name, ticks total
		ST:RegisterChannel(1120,	3, 15); -- Drain Soul
		ST:RegisterChannel(689,	1, 3); -- Drain Life
		ST:RegisterChannel(5138,	1, 3); -- Drain Mana
		ST:RegisterChannel(1949,	1, 15); -- Hellfire
		ST:RegisterChannel(5740,	2, 8); -- Rain of Fire
		ST:RegisterChannel(79268,	3, 9); -- Soul Harvest
