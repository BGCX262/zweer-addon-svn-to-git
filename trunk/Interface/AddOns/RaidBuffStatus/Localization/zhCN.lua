...
L["Black Temple"] = "黑暗神庙"
L["Blessing of Kings, with this raid configuration, is better provided by Drums of the Forgotten Kings thus allowing Blessing of Might to be used."] = "王者祝福, 在这个团队配置下, 部分人已有遗忘王者战鼓因此允许使用其他的祝福." -- Needs review
...
L["Set N - the number of people missing a buff considered to be \"MANY\""] = "当缺失增益超过数字N的时候显示为“很多”. 同时影响药剂增益" -- Needs review
