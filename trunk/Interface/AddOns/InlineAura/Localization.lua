...
L["Check to invert highlight display. Countdown and application count display aren't affected by this setting."] = true
...
L["Check to invert highlight display. Countdown and application count display aren't affected by this setting."] = "Cochez pour inverser la mise en surbrillance. L'affichage du compte à rebours et du nombre d'applications n'est pas affecté par ce réglage."
...
L["Invert highlight"] = "Inverser la surbrillance"
L["Left"] = "A gauche"
...
L["Pet buff or debuff"] = "Begleiter-Buff oder -Debuff"
L["Precise countdown"] = "Präziser Countdown"
L["Profiles"] = "Profile"
L["Regular buff or debuff"] = "Regulärer Buff oder Debuff"
...
L["Reset settings to global defaults."] = "Einstellungen auf globalen Standard zurücksetzen."
...
L["Self buff or debuff"] = "Selbst-Buff oder -Debuff"
...
L["Auras to look up"] = "Auras a mostrar"
...
L["Center"] = "Centro"
L["Check to have a more accurate countdown display instead of default Blizzard rounding."] = "Marcalo para usar mostrar una cuenta atras más precisa en vez de la Blizzard"
L["Check to hide the aura application count (charges or stacks)."] = "Marca para esconder el contador de aplicaciones (cargas o acumulaciones)"
L["Check to hide the aura countdown."] = "Marcalo para ocultar la cuenta atras"
L["Check to hide the aura duration countdown."] = "Marca esto para ocultar la duración de la cuenta atras del aura"
L["Check to ignore buffs cast by other characters."] = "Marcalo para ignorar beneficios lanzados por otros personajes"
L["Check to ignore debuffs cast by other characters."] = "Marcalo para ignorar perjuicios lanzados por otros personajes"
L["Check to only show aura you applied. Uncheck to always show aura, even when applied by others. Leave grayed to use default settings."] = "Marcalo para mostrar solo el aura que tu has lanzado. Desmarcalo para mostrar siempre el aura, incluso cuando otro la ha lanzado"
L["Check to totally disable this spell. No border highlight nor text is displayed for disabled spells."] = "Marcalo para desactivar totalmente este hechizo. No se mostrara ni el borde resaltado ni el texto para los hechizos desactivados"
...
L["Do you really want to remove these aura specific settings ?"] = "¿Quieres eliminar realmente los ajustes específicos de este aura?"
L["Dynamic countdown"] = "Cuenta atras dinamica"
L["Either OmniCC or CooldownCount is loaded so aura countdowns are displayed using small font at the bottom of action buttons."] = "OnmiCC o CooldownCount esta cargado así que la cuenta atras del aura se mostara usando fuente pequeña en la parte inferior de los botones de accion"
L["Enter additional aura names to check. This allows to check for alternative or equivalent auras. Some spells also apply auras that do not have the same name as the spell."] = "Introduce nombres de hechizos adicionales. Esto te permite comprobar hechizos alternativos o equilaventes. Algunos hechizos también aplican auras que no tienen el mismo nombre que el hechizo"
L["Enter one aura name per line. They are spell-checked ; errors will prevents you to validate."] = "Introduce solo un aura por linea. Son comprobadores de hechizo ; los errores evitan que valides"
L["Enter the name of the spell for which you want to add specific settings. Non-existent spell or item names are rejected."] = "Introduce el nombre del hechizo para el cual quieres añadir ajustes especificos. Un hechizo no existente o nombres de objetos seran retrazados"
...
L["Pet buff or debuff"] = "Benificio o perjuicio de la mascota"
L["Precise countdown"] = "Cuenta atras precisa"
L["Profiles"] = "Perfiles"
L["Regular buff or debuff"] = "Beneficio o perjuicio normal"
L["Remove spell"] = "Eliminar hechizo"
L["Remove spell specific settings."] = "Eliminar ajustes específicos del hechizo."
L["Reset settings"] = "Resetear opciones"
L["Reset settings to global defaults."] = "Resetear a opciones por defecto"
...
L["Select the remaining time threshold under which tenths of second are displayed."] = "Selecciona el umbral de tiempo restante bajo el cual se muestran decimas de segundo "
L["Select the spell to edit or to remove its specific settings. Spells with specific defaults are written in |cff77ffffcyan|r. Removed spells with specific defaults are written in |cff777777gray|r."] = "Selecciona el hechizo para editar o borrar sus ajustes especificos. Los hechizos con ajustes especificos estan escritos en  |cff77ffffazul|r. Los Hechizos borrados con ajustes especificos estan escritos en |cff777777gris|r."
...
L["Self buff or debuff"] = "Beneficio propio o perjuicio"
...
L["The small font is used to display application count (and countdown when cooldown addons are loaded)."] = "Se esta usando fuente pequeña para mostrar el contador de aplicacion (y la cuenta atras cuando se esta cargado también un addon de cuenta atras)"
L["Top"] = "Arriba"
...
L["Check to totally disable this spell. No border highlight nor text is displayed for disabled spells."] = "檢查完全停用此法術。沒有邊框突出顯示的文本，也為停用法術。"
...
L["Pet buff or debuff"] = "寵物增益或減益效果"
...
L["Self buff or debuff"] = "自己增益或減益效果"
