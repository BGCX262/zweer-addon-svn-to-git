...
local tabdata = {
	DEATHKNIGHT = {
		{ background = "DeathKnightBlood", icon = "Interface\\Icons\\Spell_Deathknight_BloodPresence", r = 1, g = 0, b = 0, role1 = "TANK" },
		{ background = "DeathKnightFrost", icon = "Interface\\Icons\\Spell_Deathknight_FrostPresence", r = 0.3, g = 0.5, b = 1, role1 = "DAMAGER" },
		{ background = "DeathKnightUnholy", icon = "Interface\\Icons\\Spell_Deathknight_UnholyPresence", r = 0.2, g = 0.8, b = 0.2, role1 = "DAMAGER" },
	},
	WARRIOR = {
		{ background = "WarriorArms", icon = "Interface\\Icons\\Ability_Warrior_SavageBlow", r = 1, g = 0.72, b = 0.1, role1 = "DAMAGER" },
		{ background = "WarriorFury", icon = "Interface\\Icons\\Ability_Warrior_InnerRage", r = 1, g = 0, b = 0, role1 = "DAMAGER" },
		{ background = "WarriorProtection", icon = "Interface\\Icons\\Ability_Warrior_DefensiveStance", r = 0.3, g = 0.5, b = 1, role1 = "TANK" },
	},
	ROGUE = {
		{ background = "RogueAssassination", icon = "Interface\\Icons\\Ability_Rogue_Eviscerate", r = 0.5, g = 0.8, b = 0.5, role1 = "DAMAGER" },
		{ background = "RogueCombat", icon = "Interface\\Icons\\Ability_BackStab", r = 1, g = 0.5, b = 0, role1 = "DAMAGER" },
		{ background = "RogueSubtlety", icon = "Interface\\Icons\\Ability_Stealth", r = 0.3, g = 0.5, b = 1, role1 = "DAMAGER" },
	},
	MAGE = {
		{ background = "MageArcane", icon = "Interface\\Icons\\Spell_Holy_MagicalSentry", r = 0.7, g = 0.2, b = 1, role1 = "DAMAGER" },
		{ background = "MageFire", icon = "Interface\\Icons\\Spell_Fire_FireBolt02", r = 1, g = 0.5, b = 0, role1 = "DAMAGER" },
		{ background = "MageFrost", icon = "Interface\\Icons\\Spell_Frost_FrostBolt02", r = 0.3, g = 0.6, b = 1, role1 = "DAMAGER" },
	},
	PRIEST = {
		{ background = "PriestDiscipline", icon = "Interface\\Icons\\Spell_Holy_PowerWordShield", r = 1, g = 0.5, b = 0, role1 = "HEALER" },
		{ background = "PriestHoly", icon = "Interface\\Icons\\Spell_Holy_GuardianSpirit", r = 0.6, g = 0.6, b = 1, role1 = "HEALER" },
		{ background = "PriestShadow", icon = "Interface\\Icons\\Spell_Shadow_ShadowWordPain", r = 0.7, g = 0.4, b = 0.8, role1 = "DAMAGER" },
	},
	WARLOCK = {
		{ background = "WarlockCurses", icon = "Interface\\Icons\\Spell_Shadow_DeathCoil", r = 0, g = 1, b = 0.6, role1 = "DAMAGER" },
		{ background = "WarlockSummoning", icon = "Interface\\Icons\\Spell_Shadow_Metamorphosis", r = 1, g = 0, b = 0, role1 = "DAMAGER" },
		{ background = "WarlockDestruction", icon = "Interface\\Icons\\Spell_Shadow_RainOfFire", r = 1, g = 0.5, b = 0, role1 = "DAMAGER" },
	},
	HUNTER = {
		{ background = "HunterBeastMastery", icon = "INTERFACE\\ICONS\\ability_hunter_bestialdiscipline", r = 1, g = 0, b = 0.3, role1 = "DAMAGER" },
		{ background = "HunterMarksmanship", icon = "Interface\\Icons\\Ability_Hunter_FocusedAim", r = 0.3, g = 0.6, b = 1, role1 = "DAMAGER" },
		{ background = "HunterSurvival", icon = "INTERFACE\\ICONS\\ability_hunter_camouflage", r = 1, g = 0.6, b = 0, role1 = "DAMAGER" },
	},
	DRUID = {
		{ background = "DruidBalance", icon = "Interface\\Icons\\Spell_Nature_StarFall", r = 0.8, g = 0.3, b = 0.8, role1 = "DAMAGER" },
		{ background = "DruidFeralCombat", icon = "Interface\\Icons\\Ability_Racial_BearForm", r = 1, g = 0, b = 0, role1 = "DAMAGER", role2 = "TANK" },
		{ background = "DruidRestoration", icon = "Interface\\Icons\\Spell_Nature_HealingTouch", r = 0.4, g = 0.8, b = 0.2, role1 = "HEALER" },
	},
	SHAMAN = {
		{ background = "ShamanElementalCombat", icon = "Interface\\Icons\\Spell_Nature_Lightning", r = 0.8, g = 0.2, b = 0.8, role1 = "DAMAGER" },
		{ background = "ShamanEnhancement", icon = "Interface\\Icons\\Spell_Nature_LightningShield", r = 0.3, g = 0.5, b = 1, role1 = "DAMAGER" },
		{ background = "ShamanRestoration", icon = "Interface\\Icons\\Spell_Nature_MagicImmunity", r = 0.2, g = 0.8, b = 0.4, role1 = "HEALER" },
	},
	PALADIN = {
		{ background = "PALADINHOLY", icon = "Interface\\Icons\\Spell_Holy_HolyBolt", r = 1, g = 0.5, b = 0, role1 = "HEALER" },
		{ background = "PALADINPROTECTION", icon = "Interface\\Icons\\Ability_Paladin_ShieldoftheTemplar", r = 0.3, g = 0.5, b = 1, role1 = "TANK" },
		{ background = "PALADINCOMBAT", icon = "Interface\\Icons\\Spell_Holy_AuraOfLight", r = 1, g = 0, b = 0, role1 = "DAMAGER" },
	},
	Cunning = { { background = "HunterPetCunning", icon = "Interface\\Icons\\Ability_EyeOfTheOwl", r = 0, g = 0.6, b = 1, role1 = "DAMAGER" }, },
	Tenacity = { { background = "HunterPetTenacity", icon = "Interface\\Icons\\Ability_Druid_DemoralizingRoar", r = 1, g = 0.1, b = 1, role1 = "TANK" }, },
	Ferocity = { { background = "HunterPetFerocity", icon = "Interface\\Icons\\Ability_Druid_KingoftheJungle", r = 1, g = 0, b = 0, role1 = "DAMAGER" }, },
}
