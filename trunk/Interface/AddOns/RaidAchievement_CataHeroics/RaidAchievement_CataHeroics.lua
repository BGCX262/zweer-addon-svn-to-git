...
chratimerstart=nil
if GetCurrentMapAreaID()==759 then
chrafailnoreason(17) --ыытест проверить ИД совпадает ли в конце
end
end
...
if chraspisokon[3]==1 and chraachdone1 then
	if (arg2=="SPELL_MISSED" or arg2=="SPELL_DAMAGE" or arg2=="SPELL_PERIODIC_DAMAGE" or arg2=="SWING_DAMAGE") and arg6 then
		...
		if id==49208 and UnitGUID("boss1") and UnitGUID("boss1")==43778 then
		if UnitGUID("boss1") then
...
if chraspisokon[4]==1 and chraachdone1 then
	if arg2=="SPELL_CAST_SUCCESS" and arg9==92042 then
...
if arg2=="SPELL_AURA_APPLIED" and arg9==90169 then
...
--ыытест не проверено ИД! а теперь репортит во всем инсте! надо учесть тока на боссе
