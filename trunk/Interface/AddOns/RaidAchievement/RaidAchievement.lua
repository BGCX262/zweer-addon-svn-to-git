...
SendAddonMessage("RaidAchievement_info2", UnitName("player").." v."..raversion.." "..ratmp1.." "..wherereportraidach..wherereportpartyach.." installed: "..raaddoninstalledsins, arg3)
end

if arg1=="RAverwhips" and arg3=="WHISPER" then
local ratmp1=0
if pseashowfailreas then ratmp1=1 end
SendAddonMessage("RAverwhips2", UnitName("player").." v."..raversion.." "..ratmp1.." "..wherereportraidach..wherereportpartyach.." installed: "..raaddoninstalledsins, "WHISPER",arg4)
end
...
PSFeamain2_Text:SetFont(GameFontNormal:GetFont(), 15)
end
...
local ratmp1=0
if pseashowfailreas then ratmp1=1 end
print (UnitName("player").." v."..raversion.." "..ratmp1.." "..wherereportraidach..wherereportpartyach.." installed: "..raaddoninstalledsins)
if cchat==nil then
