...
local list = {
    boss = "The Lich King",--The Lich King
...
function frame:UNIT_SPELLCAST_START( event, unit, spell )
    if unit=="focus" and list.SPELL_CAST_START[spell] and UnitName( "focustarget" )==list.boss then
...
DocsUI_Nameplates.bossList.lichKing = list