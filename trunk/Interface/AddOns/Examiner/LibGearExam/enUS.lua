...
LibGearExam.Patterns = {
	...
	--  Equip: Mastery  --
	{ p = "Increases your mastery rating by (%d+)%.", s = "MASTERY" },	-- Az: new cataclysm stat, there may be different versions of this, havent seen any though
	...
	{ p = "%+(%d+) S?h?i?e?l?d? ?Block Rating", s = "BLOCK", alert = 1 }, -- Combined Pattern: Covers [Shield Enchant] [Socket Bonus]
