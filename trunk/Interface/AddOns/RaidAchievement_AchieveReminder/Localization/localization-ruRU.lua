...
ralltooltiptxt21			= "RA: Обнаруженные достижения"
...
ralldefaulttactic41			= "Адды появляются в бою только 2 типов, и только на 1 фазе босс может изменять их, убедитесь что у вас собраны все 5 типов перед тем, как переводить босса во вторую фазу и убивать его"
ralldefaulttactic42			= "Совет: тактик много, просто не летайте на вражеский корабль более чем 1 раз"
ralldefaulttactic43			= "При взрыве споры на ближайших игроков вешается эффект \"Невосприимчивость к гнили\" (25% защиты от темной магии), из 3 раз что появляются споры нужно хотя бы раз не получить этот эффект. Лучшая тактика: 2 первых игрока, что получают споры - отбегают и не дают никому получить дебафф, на 2ое же появление спор - дебафф могут получить все, кроме первых 2"
ralldefaulttactic43a			= "При взрыве споры на ближайших игроков вешается эффект \"Невосприимчивость к гнили\" (25% защиты от темной магии), из 3 раз что появляются споры нужно хотя бы раз не получить этот эффект. Лучшая тактика: 3 первых игрока, что получают споры - отбегают и не дают никому получить дебафф, на 2ое же появление спор - дебафф могут получить все, кроме первых 3"
